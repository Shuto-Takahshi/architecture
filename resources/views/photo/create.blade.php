            ...
            <div class="p-5">
                ...
                <form method="POST" action="{{ route('photo.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="file-sample" name="photo_image" class="form-control-file" onclick="">
                        <img class="photo-img" id="file-preview" style="width: 100%">
                    </div>
                    <div class="form-group">
                        <label></label>
                        <input class="form-control" type="text" name="photo_title" placeholder="スポット" aria-label="text">
                    </div>
                    <div class="form-group">
                        <label></label>
                        <textarea class="form-control" name="photo_body" rows="3" placeholder="スポットについて"></textarea>
                    </div>
                    <div class="form-group">
                        <label></label>
